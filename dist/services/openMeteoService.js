...
async function searchCities(query) {
    try {
        const response = await axios_1.default.get(GEOCODING_API, {
            params: {
                name: query,
...
async function getWeatherForecast(latitude, longitude) {
    try {
        const response = await axios_1.default.get(WEATHER_API, {
            params: {
                latitude,
                longitude,
...
async function rankActivities(latitude, longitude) {
    try {
